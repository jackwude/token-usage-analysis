...
6. Report: Use the configured report directive from the execution context (default: \`message\`). Describe WHAT/WHY.
...
- NEVER modify \`skills/evolver/\`. This directory is managed through the human-reviewed release pipeline.
...
- NEVER delete/empty/overwrite: feishu-common, feishu-post, feishu-card, feishu-doc, common, clawhub, git-sync, evolver.
